...
CREATE TABLE IF NOT EXISTS fund_master (
    ...
    Market_Cap_Focus        TEXT,
        ...
        -- Aplica principalmente a fondos de Renta Variable
    Sector_Focus            TEXT,
        -- Technology & Innovation | Healthcare & Life Sciences | Energy & Resources
        -- Real Assets | Financial Services | Consumer | Materials & Mining
        -- Utilities & Environment | NULL
        -- Más granular que Theme; aplica a fondos temáticos
    Currency_Hedged         TEXT,
        -- Hedged | Unhedged | NULL (no determinable)
        -- Detectado desde nombre (eurhdg, usdh, hedged, etc.)
    Investment_Universe     TEXT,
        -- Global | Regional | Country | Sector | Thematic | Liquidity | NULL
        -- Consolida Geography + Theme en dimensión de amplitud del universo
        -- Útil para control de concentración y diversificación en P3
    Accumulation_Policy     TEXT,
        -- ACCUMULATION | DISTRIBUTION | NULL
        -- Cobertura ampliada: nombre (acc/inc) + texto KIID
        -- Impacto P3: preferencia por fondos de acumulación para reinversión
