...
python -m proyecto2.src.discovery.nav_discovery --mode discover --isin LU1873127366 --dry-run --verbose
python -m proyecto2.src.discovery.nav_discovery --mode load --isin LU1873127366 --dry-run --verbose

# Paso 3 — prueba con 10 ISINs aleatorios (escribe en nav_sources)
python -m proyecto2.src.discovery.nav_discovery --mode discover --sample 10
...
python -m proyecto2.src.discovery.test_historia
