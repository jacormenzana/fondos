...
::    Rutas ABSOLUTAS para ser independientes del CWD (pushd/popd).
...
:: ============================================================
:: Cost Diag
:: FIX: ejecutar desde %ROOT% con PYTHONPATH ya exportado arriba.
::      Rutas ABSOLUTAS para --db / --kiid-dir / --out.
::      --out con timestamp para evitar colisiones en re-runs.
:: ============================================================
set DIAG_OUT=%DIAG_OUT_DIR%\cost_diag_%STAMP2%_p1g.csv
