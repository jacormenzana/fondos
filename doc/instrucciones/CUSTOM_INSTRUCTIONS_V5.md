# CUSTOM INSTRUCTIONS V5 - COMPLETE AND EXHAUSTIVE
# Investment Fund Classification - Funds Project

**Update:** June 6, 2026
**Version:** 5.0 (Sections 2 & 3 re-grounded on the live `fund_master` export `p1_export_20260606.xlsx`; Section 6 relations promoted to concrete rules)
...
**END OF CUSTOM INSTRUCTIONS V5**
*Version 5.0 — Sections 2 & 3 re-grounded on `p1_export_20260606.xlsx`; Section 6 relations operationalized as INTER-12…INTER-17.*
